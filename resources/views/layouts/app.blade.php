...
@section('body')
    <div
        ...
        <div
            class="sticky top-2 z-50 flex flex-row items-center justify-between px-6 sm:px-8 my-2 bg-white/75 backdrop-blur transition-all duration-300 ring-zinc-300"
            ...
            <div class="font-medium font-serif tracking-wide text-lg hover:text-zinc-700">
                <a wire:navigate href="{{ route('home') }}" class=" flex items-center gap-x-2">
            ...
            @if (Route::has('login'))
                <div class="py-4 flex gap-x-4 items-center">
                    @auth
                        ...
                        <a wire:navigate href="{{ route('listing.index') }}"
