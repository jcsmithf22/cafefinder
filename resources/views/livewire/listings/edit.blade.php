    ...
    <form class="flex flex-col gap-y-12" wire:submit="update">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-2">
                <flux:input type="email" wire:model="form.email" label="Email address" />
            </div>

            <div class="sm:col-span-2">
                <flux:input wire:model="form.phone" label="Phone number" mask="(999) 999-9999" placeholder="(123) 456-7890"  />
            </div>
